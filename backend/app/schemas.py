...
class ZipAnalyzeResponse(BaseModel):
    ...
    file_count: int = Field(
        ...,
        description="Number of files successfully analysed.",
        example=5,
    )
    ...
    grade: str = Field(
        ...,
        description="Project-level letter grade A–F.",
        example="C",
    )
    summary: str = Field(
        ...,
...
class LivenessResponse(BaseModel):
    ...
    status: str = Field(
        ...,
        description="Always `ok` when this response is returned.",
        example="ok",
    )
...
class HistoryRecord(BaseModel):
    ...
    code: str = Field(
        ...,
        description="The analysed source code.",
    )
    result_json: str = Field(
        ...,
        description="The analysis result as a JSON string.",
    )
...
class FavoriteRecord(BaseModel):
    ...
    title: str = Field(
        ...,
        description="User-supplied title.",
        example="Divide function bug check",
    )
    action: str = Field(
        ...,
...
class ShareCreateRequest(BaseModel):
    ...
    @classmethod
    def ensure_result_present(
        cls, model: "ShareCreateRequest"
    ) -> "ShareCreateRequest":
...
class ShareRecord(BaseModel):
    ...
    code: str = Field(
        ...,
        description="The shared source code.",
    )
    result: dict[str, Any] = Field(
        ...,
        description="The shared analysis result.",
    )
    created_at: str = Field(
        ...,
...
=======
    provider: str = Field(
        ...,
        description="LLM provider used, or `rule-based`.",
        example="openai",
    )
    model: str = Field(
        ...,
