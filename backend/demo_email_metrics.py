...
def print_metrics():
    ...
    print(
        f'qyverixai_email_sent_total{{type="digest", status="success"}} = {success_val}'
    )
    print(
        f'qyverixai_email_sent_total{{type="digest", status="failed"}}  = {failed_val}'
    )
    print(
        f'qyverixai_email_send_duration_seconds_count{{type="digest"}} = {duration_count}'
    )
    print(
        f'qyverixai_email_send_duration_seconds_sum{{type="digest"}}   = {duration_sum:.4f}s'
    )
    if duration_count > 0:
