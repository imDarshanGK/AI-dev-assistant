 /* ═══════════════════════════════════════════════════════════════
      ...
      const TRANSLATIONS = {
        en: {
          ...
          lang_option_ta: "தமிழ் (Tamil)",
          lang_option_hi: "हिन्दी (Hindi)",
          lang_option_fr: "Français (French)",
          lang_tab_python: "Python",
          lang_tab_javascript: "JavaScript",
          lang_tab_typescript: "TypeScript",
          lang_tab_java: "Java",
          lang_tab_cpp: "C++",
          nav_github: "GitHub",
          ...
          pill_patterns_title: "40+ Bug Patterns",
          pill_patterns_desc: "Python, JS, TS, Java, C++",
          mode_explain: "Code Explanation",
          pill_explain_desc: "Plain English breakdowns",
          mode_improve: "Smart Suggestions",
          pill_improve_desc: "Quality score + grade",
          pill_theme_title: "Dark / Light Mode",
          pill_theme_desc: "Persisted preference",
          pill_upload_title: "File Upload",
          ...
          mode_full: "Full",
          mode_debug: "Debug",
          api_url_placeholder: "https://qyverixai.onrender.com",
          api_status_disconnected: "Disconnected",
          api_status_connected: "Connected",
          api_status_unreachable: "Unreachable",
          api_status_error: "Error {status}",
          btn_ping: "Ping",
          btn_analyze_code: "Analyze Code",
          desktop_hint: "(Ctrl+Enter)",
          results_title: "Analysis Results",
          tab_explain: "Explain",
          tab_debug: "Debug",
          tab_improve: "Improve",
          empty_explain_title: "No analysis yet",
          empty_explain_desc: "Paste your code and click Analyze to see results",
          empty_debug_title: "No bugs scanned",
          empty_debug_desc: "Run analysis to detect issues in your code",
          empty_suggest_title: "No suggestions yet",
          empty_suggest_desc: "Run analysis to get improvement ideas",
          history_title: "Query History",
          favorites_title: "Saved Favorites",
          empty_history: "No history yet. Run your first analysis.",
          empty_favorites: "No favorites saved yet.",
          btn_clear: "Clear",
          footer_license: "MIT License",
          footer_built_for: "Built for the open source community",
          confirm_clear_history: "Clear all history? This cannot be undone.",
          confirm_clear_favs: "Clear all favorites? This cannot be undone.",
          toast_code_copied: "Code copied!",
          toast_api_reachable: "API is reachable",
          toast_api_unreachable: "Cannot reach API. Check the URL.",
          toast_please_paste: "Please paste some code first.",
          toast_saved_favorites: "Saved to favorites",
          toast_report_downloaded: "Report downloaded",
          toast_sample_loaded: "Sample code loaded — click Analyze!",
          ...
          debug_info: "Info",
          debug_line: "Line {line}",
          suggest_quality_score: "Quality Score",
          suggest_perfect_title: "Perfect score!",
          suggest_perfect_desc: "No improvement suggestions found.",
          suggest_priority: "{priority} priority",
          btn_copy: "Copy code",
          btn_upload: "Upload file",
          btn_save_favorites: "Save to favorites",
          btn_download_results: "Download results",
          btn_toggle_theme: "Toggle theme",
          analyze_btn_title: "Analyze Code (Ctrl+Enter)",
          meta_lines: "{count} lines",
          meta_functions: "{count} functions",
        ...
        ta: {
          ...
          lang_tab_java: "Java",
          lang_tab_cpp: "C++",
          nav_github: "கிட்ஹப் (GitHub)",
          nav_api_docs: "ஏபிஐ ஆவணங்கள் (API Docs)",
          hero_badge: "திறந்த மூல · ஏஐ-ஆற்றல் · இலவசம்",
          hero_title: "பிழையறி. புரிந்துகொள்.<br /><em>வேகமாக அனுப்பு.</em>",
          hero_subtitle: "உங்கள் குறியீட்டை ஒட்டி, உடனடி பிழை கண்டறிதல், எளிய ஆங்கில விளக்கங்கள் மற்றும் பயனுள்ள மேம்பாட்டு பரிந்துரைகளைப் பெறுங்கள் — கணக்கு தேவையில்லை.",
          btn_start_analyzing: "பகுப்பாய்வைத் தொடங்கு",
          btn_try_sample: "மாதிரிக் குறியீட்டை முயல்க",
          btn_star_github: "கிட்ஹப்பில் ஸ்டார் செய்க",
          pill_patterns_title: "40+ பிழை வடிவங்கள்",
          pill_patterns_desc: "Python, JS, TS, Java, C++",
          mode_explain: "குறியீடு விளக்கம்",
          pill_explain_desc: "எளிய ஆங்கில விளக்கங்கள்",
          mode_improve: "ஸ்மார்ட் பரிந்துரைகள்",
          pill_improve_desc: "தரமான மதிப்பெண் + தரம்",
          pill_theme_title: "இருண்ட / ஒளி முறை",
          pill_theme_desc: "சேமிக்கப்பட்ட விருப்பம்",
          pill_upload_title: "கோப்பு பதிவேற்றம்",
          pill_upload_desc: ".py .js .ts .java .cpp .kt .zip",
          editor_title: "குறியீட்டு எடிட்டர்",
          ...
          api_url_placeholder: "https://qyverixai.onrender.com",
          api_status_disconnected: "இணைப்பு துண்டிக்கப்பட்டது",
          api_status_connected: "இணைக்கப்பட்டது",
          api_status_unreachable: "அடைய முடியாதது",
          api_status_error: "பிழை {status}",
          btn_ping: "பிங்",
          btn_analyze_code: "குறியீட்டை பகுப்பாய்",
          desktop_hint: "(Ctrl+Enter)",
          results_title: "பகுப்பாய்வு முடிவுகள்",
          tab_explain: "விளக்கு",
          tab_debug: "பிழைத்திருத்து",
          tab_improve: "மேம்படுத்து",
          empty_explain_title: "இன்னும் பகுப்பாய்வு இல்லை",
          empty_explain_desc: "விளைவுகளைக் காண குறியீட்டை ஒட்டி, பகுப்பாய் என்பதைக் கிளிக் செய்யவும்",
          empty_debug_title: "பிழைகள் எதுவும் கண்டறியப்படவில்லை",
          empty_debug_desc: "உங்கள் குறியீட்டில் உள்ள சிக்கல்களைக் கண்டறிய பகுப்பாய்வை இயக்கவும்",
          empty_suggest_title: "இன்னும் பரிந்துரைகள் இல்லை",
          empty_suggest_desc: "மேம்பாட்டு யோசனைகளைப் பெற பகுப்பாய்வை இயக்கவும்",
          history_title: "வினவல் வரலாறு",
          favorites_title: "சேமிக்கப்பட்ட பிடித்தவை",
          empty_history: "இன்னும் வரலாறு இல்லை. உங்கள் முதல் பகுப்பாய்வை இயக்கவும்.",
          empty_favorites: "இன்னும் பிடித்தவை எதுவும் சேமிக்கப்படவில்லை.",
          btn_clear: "அழி",
          footer_license: "எம்ஐடி உரிமம் (MIT License)",
          footer_built_for: "திறந்த மூல சமூகத்திற்காக உருவாக்கப்பட்டது",
          confirm_clear_history: "எல்லா வரலாற்றையும் அழிக்கவா? இதை மாற்ற முடியாது.",
          confirm_clear_favs: "பிடித்தவை அனைத்தையும் அழிக்கவா? இதை மாற்ற முடியாது.",
          toast_code_copied: "குறியீடு நகலெடுக்கப்பட்டது!",
          toast_api_reachable: "ஏபிஐ அணுகக்கூடியது",
          toast_api_unreachable: "ஏபிஐ-ஐ அணுக முடியவில்லை. முகவரியைச் சரிபார்க்கவும்.",
          toast_please_paste: "தயவுசெய்து முதலில் குறியீட்டை ஒட்டவும்.",
          toast_saved_favorites: "பிடித்தவற்றில் சேமிக்கப்பட்டது",
          toast_report_downloaded: "அறிக்கை பதிவிறக்கம் செய்யப்பட்டது",
          toast_sample_loaded: "மாதிரிக் குறியீடு ஏற்றப்பட்டது — பகுப்பாய் என்பதைக் கிளிக் செய்க!",
          toast_history_cleared: "வரலாறு அழிக்கப்பட்டது",
          ...
          debug_warnings: "எச்சரிக்கைகள்",
          debug_info: "தகவல்",
          debug_line: "வரி {line}",
          suggest_quality_score: "தர மதிப்பெண்",
          suggest_perfect_title: "சரியான மதிப்பெண்!",
          suggest_perfect_desc: "மேம்பாட்டு பரிந்துரைகள் எதுவும் இல்லை.",
          suggest_priority: "{priority} முன்னுரிமை",
          btn_copy: "குறியீட்டை நகலெடு",
          btn_upload: "கோப்பைப் பதிவேற்று",
          btn_save_favorites: "பிடித்தவற்றில் சேமி",
          btn_download_results: "முடிவுகளைப் பதிவிறக்கு",
          btn_toggle_theme: "தீம் மாற்று",
          analyze_btn_title: "குறியீட்டை பகுப்பாய் (Ctrl+Enter)",
          meta_lines: "{count} வரிகள்",
          meta_functions: "{count} செயல்பாடுகள்",
        ...
        hi: {
          ...
          lang_tab_java: "Java",
          lang_tab_cpp: "C++",
          nav_github: "गिटहब (GitHub)",
          nav_api_docs: "एपीआई दस्तावेज़ (API Docs)",
          hero_badge: "ओपन सोर्स · एआई-संचालित · मुफ्त",
          ...
          pill_patterns_desc: "Python, JS, TS, Java, C++",
          mode_explain: "कोड का स्पष्टीकरण",
          pill_explain_desc: "सरल स्पष्टीकरण",
          mode_improve: "स्मार्ट सुझाव",
          pill_improve_desc: "क्वालिटी स्कोर + ग्रेड",
          pill_theme_title: "डार्क / लाइट मोड",
          pill_theme_desc: "सहेजी गई प्राथमिकता",
          ...
          mode_debug: "डीबग",
          api_url_placeholder: "https://qyverixai.onrender.com",
          api_status_disconnected: "डिस्कनेक्टेड",
          api_status_connected: "कनेक्टेड",
          api_status_unreachable: "पहुंच से बाहर",
          api_status_error: "त्रुटि {status}",
          btn_ping: "पिंग",
          btn_analyze_code: "कोड का विश्लेषण करें",
          desktop_hint: "(Ctrl+Enter)",
          results_title: "विश्लेषण के परिणाम",
          tab_explain: "समझाएं",
          tab_debug: "डीबग",
          tab_improve: "सुधारें",
          empty_explain_title: "अभी तक कोई विश्लेषण नहीं",
          empty_explain_desc: "परिणाम देखने के लिए अपना कोड पेस्ट करें और विश्लेषण पर क्लिक करें",
          empty_debug_title: "कोई बग नहीं मिला",
          empty_debug_desc: "अपने कोड में समस्याओं का पता लगाने के लिए विश्लेषण चलाएं",
          empty_suggest_title: "अभी तक कोई सुझाव नहीं",
          empty_suggest_desc: "सुधार के विचार प्राप्त करने के लिए विश्लेषण चलाएं",
          history_title: "क्वेरी इतिहास",
          favorites_title: "सहेजे गए पसंदीदा",
          empty_history: "अभी तक कोई इतिहास नहीं है। अपना पहला विश्लेषण चलाएं।",
          empty_favorites: "अभी तक कोई पसंदीदा सहेजा नहीं गया है।",
          btn_clear: "साफ करें",
          footer_license: "एमआईटी लाइसेंस (MIT License)",
          footer_built_for: "ओपन सोर्स समुदाय के लिए निर्मित",
          confirm_clear_history: "इतिहास पूरी तरह साफ करें? इसे पूर्ववत नहीं किया जा सकता।",
          confirm_clear_favs: "सभी पसंदीदा साफ करें? इसे पूर्ववत नहीं किया जा सकता।",
          toast_code_copied: "कोड कॉपी किया गया!",
          toast_api_reachable: "एपीआई पहुंच योग्य है",
          toast_api_unreachable: "एपीआई तक नहीं पहुंचा जा सकता। यूआरएल की जांच करें।",
          toast_please_paste: "कृपया पहले कुछ कोड पेस्ट करें।",
          toast_saved_favorites: "पसंदीदा में सहेजा गया",
          toast_report_downloaded: "रिपोर्ट डाउनलोड हो गई",
          toast_sample_loaded: "सैंपल कोड लोड हो गया — विश्लेषण पर क्लिक करें!",
          toast_history_cleared: "इतिहास साफ कर दिया गया",
          ...
          debug_warnings: "चेतावनी",
          debug_info: "जानकारी",
          debug_line: "पंक्ति {line}",
          suggest_quality_score: "क्वालिटी स्कोर",
          suggest_perfect_title: "उत्कृष्ट स्कोर!",
          suggest_perfect_desc: "कोई सुधार सुझाव नहीं मिला।",
          suggest_priority: "{priority} प्राथमिकता",
          btn_copy: "कोड कॉपी करें",
          btn_upload: "फ़ाइल अपलोड करें",
          btn_save_favorites: "पसंदीदा में सहेजें",
          btn_download_results: "परिणाम डाउनलोड करें",
          btn_toggle_theme: "थीम बदलें",
          analyze_btn_title: "कोड का विश्लेषण करें (Ctrl+Enter)",
          meta_lines: "{count} पंक्तियाँ",
          meta_functions: "{count} फ़ंक्शन",
        ...
        fr: {
          ...
          hero_badge: "Open Source · Propulsé par l'IA · Gratuit",
          hero_title: "Déboguez. Comprenez.<br /><em>Lisez plus vite.</em>",
          hero_subtitle: "Collez votre code et obtenez une détection instantanée des bogues, des explications simples et des suggestions d'amélioration exploitables — aucun compte requis.",
          btn_start_analyzing: "Démarrer l'analyse",
          btn_try_sample: "Essayer l'exemple",
          btn_star_github: "Star sur GitHub",
          pill_patterns_title: "40+ Modèles de bogues",
          pill_patterns_desc: "Python, JS, TS, Java, C++",
          mode_explain: "Explication de code",
          pill_explain_desc: "Analyses en français simple",
          mode_improve: "Suggestions intelligentes",
          pill_improve_desc: "Score de qualité + note",
          pill_theme_title: "Mode Sombre / Clair",
          pill_theme_desc: "Préférence persistée",
          pill_upload_title: "Télécharger un fichier",
          pill_upload_desc: ".py .js .ts .java .cpp .kt .zip",
          editor_title: "Éditeur de code",
          ...
          mode_debug: "Débogage",
          api_url_placeholder: "https://qyverixai.onrender.com",
          api_status_disconnected: "Déconnecté",
          api_status_connected: "Connecté",
          api_status_unreachable: "Inaccessible",
          api_status_error: "Erreur {status}",
          btn_ping: "Ping",
          btn_analyze_code: "Analyser le code",
          desktop_hint: "(Ctrl+Enter)",
          results_title: "Résultats de l'analyse",
          tab_explain: "Expliquer",
          tab_debug: "Déboguer",
          tab_improve: "Améliorer",
          empty_explain_title: "Aucune analyse pour le moment",
          empty_explain_desc: "Collez votre code et cliquez sur Analyser pour voir les résultats",
          empty_debug_title: "Aucun bogue détecté",
          empty_debug_desc: "Exécutez l'analyse pour détecter les problèmes dans votre code",
          empty_suggest_title: "Aucune suggestion pour le moment",
          empty_suggest_desc: "Exécutez l'analyse pour obtenir des idées d'amélioration",
          history_title: "Historique des requêtes",
          favorites_title: "Favoris enregistrés",
          empty_history: "Aucun historique pour le moment. Lancez votre première analyse.",
          empty_favorites: "Aucun favori enregistré pour le moment.",
          btn_clear: "Effacer",
          footer_license: "Licence MIT",
          footer_built_for: "Conçu pour la communauté open source",
          confirm_clear_history: "Effacer tout l'historique ? Cette action est irréversible.",
          confirm_clear_favs: "Effacer tous les favoris ? Cette action est irréversible.",
          toast_code_copied: "Code copié !",
          toast_api_reachable: "L'API est accessible",
          toast_api_unreachable: "Impossible de joindre l'API. Vérifiez l'URL.",
          toast_please_paste: "Veuillez d'abord coller du code.",
          toast_saved_favorites: "Enregistré dans les favoris",
          toast_report_downloaded: "Rapport téléchargé",
          toast_sample_loaded: "Exemple de code chargé — cliquez sur Analyser !",
          ...
          debug_warnings: "Avertissements",
          debug_info: "Infos",
          debug_line: "Ligne {line}",
          suggest_quality_score: "Score de qualité",
          suggest_perfect_title: "Score parfait !",
          suggest_perfect_desc: "Aucune suggestion d'amélioration trouvée.",
          suggest_priority: "Priorité {priority}",
          btn_copy: "Copier le code",
          btn_upload: "Télécharger le fichier",
          btn_save_favorites: "Enregistrer dans les favoris",
          btn_download_results: "Télécharger les résultats",
          btn_toggle_theme: "Changer le thème",
          analyze_btn_title: "Analyser le code (Ctrl+Enter)",
          meta_lines: "{count} lignes",
          meta_functions: "{count} fonctions",
          meta_classes: "{count} classes",
      ...
      const REMOTE_API_BASE = 'https://qyverixai.onrender.com';

      let selectedMode = 'analyze';
      let selectedZipFile = null;
      let appLang = localStorage.getItem('qyx_lang') || 'en';
      ...
      function setAppLanguage(lang) {
        appLang = lang;
        localStorage.setItem('qyx_lang', lang);
        ...
        renderFavorites();
        if (currentResult) {
          renderResults(currentResult, editor.value);
        }
      }
      ...
      function syncApiStatusText() {
        ...
        const state = apiStatusText.dataset.status || 'disconnected';
        const stateToKey = {
          connected: 'api_status_connected',
          unreachable: 'api_status_unreachable',
          error: 'api_status_error',
          disconnected: 'api_status_disconnected',
        };
        const key = stateToKey[state] || 'api_status_disconnected';
        const text = getTranslation(key);
        apiStatusText.textContent = key === 'api_status_error'
          ? text.replace('{status}', apiStatusText.dataset.statusCode || '')
          : text;
      }

      function looksLikeRestoredPageSource(text) {
        return /<\s*html|<\s*style|<\s*script|function\s+updateEditor\s*\(|\.stat-bar|\.hero\s*\{|\.workspace\s*\{/i.test(text);
      }
      ...
      function getApiFallbackBase(base) {
        ...
        return /localhost:8000|127\.0\.0\.1:8000/i.test(normalized) ? REMOTE_API_BASE : null;
      }

      function persistApiBase(base) {
        const normalized = String(base || '').replace(/\/$/, '');
        if (!normalized) return;
        localStorage.setItem('qyx_apiUrl', normalized);
        if (apiUrlInput) apiUrlInput.value = normalized;
      }

      async function fetchWithApiFallback(base, path, options) {
      ...
      function normalizeEditorOnLoad() {
        if (looksLikeRestoredPageSource(editor.value || '')) {
          editor.value = '';
          updateEditor();
        }
      }

      normalizeEditorOnLoad();
      window.addEventListener('pageshow', normalizeEditorOnLoad);
      setTimeout(normalizeEditorOnLoad, 0);
      ...
      /* ── Drag and Drop (visual drop zone on editor) ── */
      const editorWrap  = document.getElementById('editorWrap');
      const dropOverlay = document.getElementById('dropOverlay');
      let dragCounter = 0; // track nested dragenter/dragleave events

      // Prevent default browser file-open on body
      ...
      function handleUploadedFile(file) {
        ...
        if (ext === 'zip') {
          ...
          document.querySelectorAll('.mode-btn').forEach(x => {
            x.classList.toggle('active', x.dataset.mode === 'analyze');
            x.setAttribute('aria-pressed', x.dataset.mode === 'analyze' ? 'true' : 'false');
          });
      ...
      document.querySelectorAll('.result-tab').forEach(t => {
        t.addEventListener('click', () => {
          ...
          document.querySelectorAll('.result-pane').forEach(x => x.classList.remove('active'));
      ...
      document.getElementById('copyBtn').addEventListener('click', () => {
        ...
        navigator.clipboard.writeText(editor.value).then(() => toast(getTranslation('toast_code_copied'), 'success'));
      });

      /* ═══════════════════════════════════════════════════════════════
         API PING
      ═══════════════════════════════════════════════════════════════ */
      async function pingApi({ notify = false } = {}) {
        if (!apiUrlInput || !apiStatusText) return;
        const base = getApiBase();
        try {
          const { response: r, baseUsed, fallbackUsed } = await fetchWithApiFallback(base, '/health', { signal: AbortSignal.timeout(5000) });
          if (fallbackUsed) persistApiBase(baseUsed);
          if (r.ok) {
            apiDot?.classList.add('connected');
            apiStatusText.dataset.status = 'connected';
            delete apiStatusText.dataset.statusCode;
            syncApiStatusText();
            if (notify) {
              toast(getTranslation('toast_api_reachable'), 'success');
            }
          } else {
            apiDot?.classList.remove('connected');
            apiStatusText.dataset.status = 'error';
            apiStatusText.dataset.statusCode = String(r.status);
            syncApiStatusText();
          }
        } catch {
          apiDot?.classList.remove('connected');
          apiStatusText.dataset.status = 'unreachable';
          delete apiStatusText.dataset.statusCode;
          syncApiStatusText();
          if (notify) {
            toast(getTranslation('toast_api_unreachable'), 'error');
          }
        }
      }
      ...
      async function doAnalyze() {
        ...
        if (!selectedZipFile && !code) { toast(getTranslation('toast_please_paste'), 'error'); return; }
        ...
        try {
          if (selectedZipFile) {
            ...
            const { response: res, baseUsed, fallbackUsed } = await fetchWithApiFallback(base, '/analyze/zip/', {
              method: 'POST',
              body: formData,
            ...
            addToHistory(`ZIP: ${selectedZipFile.name}`, data);
            apiDot?.classList.add('connected');
            if (apiStatusText) apiStatusText.textContent = 'Connected';
            document.getElementById('engineBar').style.display = 'flex';
            engineInfo.textContent = `${data.provider || 'rule-based'} · ${data.model || ''}`;
            timeInfo.textContent = data.analysis_time_ms ? data.analysis_time_ms + 'ms' : '';
          ...
          const data = await res.json();
          const elapsed = res.headers.get('X-Process-Time-Ms');

          // Normalize to full analysis shape
          let result;
          if (selectedMode === 'analyze') {
            result = data;
          } else if (selectedMode === 'explain') {
            result = { explanation: data, debugging: null, suggestions: null, provider: 'rule-based', analysis_time_ms: null };
          } else if (selectedMode === 'debug') {
            result = { explanation: null, debugging: data, suggestions: null, provider: 'rule-based', analysis_time_ms: null };
          } else {
            result = { explanation: null, debugging: null, suggestions: data, provider: 'rule-based', analysis_time_ms: null };
          }
          ...
          apiDot?.classList.add('connected');
          if (apiStatusText) apiStatusText.textContent = getTranslation('api_status_connected');
          document.getElementById('engineBar').style.display = 'flex';
          engineInfo.textContent = (data.provider || 'rule-based') + ' · ' + (data.model || '');
          if (elapsed) timeInfo.textContent = parseFloat(elapsed).toFixed(0) + 'ms';
          else if (data.analysis_time_ms) timeInfo.textContent = data.analysis_time_ms + 'ms';
          resultActions.style.display = 'flex';
      ...
      function renderZipResults(project) {
        ...
        document.getElementById('explainBadge').textContent = `${project.file_count} files`;
        const totalIssues = project.files.reduce((sum, file) => sum + file.analysis.debugging.issues.length, 0);
        const totalSuggestions = project.files.reduce((sum, file) => sum + file.analysis.suggestions.suggestions.length, 0);
        const errorCount = project.files.reduce((sum, file) => sum + file.analysis.debugging.error_count, 0);
        const warningCount = project.files.reduce((sum, file) => sum + file.analysis.debugging.warning_count, 0);
        const infoCount = project.files.reduce((sum, file) => sum + file.analysis.debugging.info_count, 0);
        document.getElementById('debugBadge').textContent = totalIssues || '0';
        document.getElementById('suggestBadge').textContent = project.overall_project_score;

        const scoreColor = project.overall_project_score >= 80 ? 'var(--green)'
          : project.overall_project_score >= 60 ? 'var(--yellow)'
            : 'var(--red)';
        const circumference = 2 * Math.PI * 30;
        const dashOffset = circumference - (project.overall_project_score / 100) * circumference;
        const fileList = project.files.map((file, i) => {
          const analysis = file.analysis;
          const issueSummary = analysis.debugging.clean
            ? 'No issues detected'
            : `${analysis.debugging.error_count} errors · ${analysis.debugging.warning_count} warnings · ${analysis.debugging.info_count} info`;
          return `
      <details class="zip-file-card" ${i === 0 ? 'open' : ''}>
        <summary>
          <span class="zip-file-name">${escHtml(file.filename)}</span>
          <span class="zip-file-meta">${file.language} · ${analysis.suggestions.overall_score}/100 · ${issueSummary}</span>
        </summary>
        <div class="zip-file-body">
          <p>${escHtml(analysis.explanation.summary)}</p>
          <div class="zip-mini-grid">
            <span>${analysis.explanation.line_count} lines</span>
            <span>${analysis.explanation.function_count} functions</span>
            <span>${analysis.suggestions.suggestions.length} suggestions</span>
          </div>
          ${analysis.debugging.issues.slice(0, 4).map(issue => `
            <div class="zip-issue ${issue.severity}">
        ...
        const skipped = project.skipped_files.length
          ? `<div class="zip-skipped">Skipped: ${project.skipped_files.map(escHtml).join(', ')}</div>`
          : '';

        document.getElementById('explainResult').innerHTML = `
    <div class="zip-overview">
      <div class="score-ring-wrap">
        <div class="score-ring">
          ...
          <div class="score-ring-text">
            <div class="score-num" style="color:${scoreColor}">${project.overall_project_score}</div>
            <div class="score-grade">${project.grade}</div>
          </div>
        </div>
        <div class="score-info">
          <p class="score-title">Project Health</p>
          <p>${escHtml(project.summary)}</p>
        </div>
      </div>
      <div class="stat-bar">
        <div class="stat-chip"><div class="stat-chip-num">${project.file_count}</div><div class="stat-chip-label">Files</div></div>
        <div class="stat-chip error-chip"><div class="stat-chip-num">${errorCount}</div><div class="stat-chip-label">Errors</div></div>
        <div class="stat-chip warn-chip"><div class="stat-chip-num">${warningCount}</div><div class="stat-chip-label">Warnings</div></div>
        <div class="stat-chip info-chip"><div class="stat-chip-num">${infoCount}</div><div class="stat-chip-label">Info</div></div>
      </div>
      ${skipped}
      <div class="zip-file-list">${fileList}</div>
    </div>`;
    ...
    <div class="score-ring-wrap">
      ...
      <div class="score-info">
        ...
        <p>${totalSuggestions} improvement suggestion${totalSuggestions !== 1 ? 's' : ''} across ${project.file_count} file${project.file_count !== 1 ? 's' : ''}.</p>
      </div>
    </div>
    <div class="zip-file-list">${fileList}</div>`;

        document.querySelector('[data-rtab="explain"]').click();
      }
  ...
  `;
    ...
    <div class="issue-card ${issue.severity}" style="animation-delay:${i * 0.05}s" tabindex="0">
      <div class="issue-header">
        ...
        ${issue.line ? `<span class="issue-line">${getTranslation('debug_line').replace('{line}', issue.line)}</span>` : ''}
      </div>
      ...
      function renderSuggest(sugg) {
        ...
        el.style.display = 'block';
        document.getElementById('suggestBadge').textContent = sugg.suggestions.length || '0';

        const scoreColor = sugg.overall_score >= 80 ? 'var(--green)'
          : sugg.overall_score >= 60 ? 'var(--yellow)'
            : 'var(--red)';

        const circumference = 2 * Math.PI * 30;
        const dashOffset = circumference - (sugg.overall_score / 100) * circumference;
    ...
    <div class="score-ring-wrap">
      ...
      <div class="score-info">
        <p class="score-title">${getTranslation('suggest_quality_score')}</p>
        <p>${sugg.next_step}</p>
      </div>
    </div>`;

        const cards = sugg.suggestions.length === 0
          ? `<div class="clean-state"><div class="clean-icon"><svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"/></svg></div><p class="clean-title">${getTranslation('suggest_perfect_title')}</p><p>${getTranslation('suggest_perfect_desc')}</p></div>`
      ...
      function showShimmers() {
        const shims = '<div class="shimmer-card"></div>'.repeat(3);
        ['explainResult', 'debugResult', 'suggestResult'].forEach(id => {
      ...
      function resetResults() {
        ...
        ['explainBadge', 'debugBadge', 'suggestBadge'].forEach(id => {
    ...
    <div class="history-item" onclick="loadEntry('${h.id}')" tabindex="0" role="button" aria-label="${getTranslation('history_entry_label').replace('{lang}', h.lang || '?').replace('{time}', h.ts)}" onkeydown="if(event.key==='Enter'||event.key===' ') { event.preventDefault(); loadEntry('${h.id}'); }">
      ...
      document.getElementById('clearHistoryBtn').addEventListener('click', () => {
        ...
        renderHistory();
        toast(getTranslation('toast_history_cleared'), 'info');
      });
      ...
      function normalizeSavedEntryId(id) {
        const normalizedId = Number(id);
        return Number.isNaN(normalizedId) ? null : normalizedId;
      }

      function restoreSavedEntry(entry) {
        if (!entry) return;
      ...
      function loadEntry(id) {
        const normalizedId = normalizeSavedEntryId(id);
        if (normalizedId === null) return;
        const entry = history.find(h => h.id === normalizedId);
        restoreSavedEntry(entry);
      }
      ...
      document.getElementById('favBtn').addEventListener('click', () => {
        if (!currentResult || !editor.value.trim()) return;
        const entry = {
          id: Date.now(),
          code: editor.value,
          result: currentResult,
          lang: currentResult.explanation?.language || selectedLang,
          ts: new Date().toLocaleDateString(),
          preview: editor.value.slice(0, 60).replace(/\n/g, ' '),
        };
        favorites.unshift(entry);
        if (favorites.length > 30) favorites = favorites.slice(0, 30);
        localStorage.setItem('qyx_favorites', JSON.stringify(favorites));
        renderFavorites();
        toast(getTranslation('toast_saved_favorites'), 'success');
      });

      function renderFavorites() {
        if (!favorites.length) {
          favList.innerHTML = `<div class="list-empty" data-i18n="empty_favorites">${getTranslation('empty_favorites')}</div>`;
          return;
        }
        favList.innerHTML = favorites.map(f => `
    <div class="fav-item" onclick="loadFav('${f.id}')" tabindex="0" role="button" aria-label="${getTranslation('favorite_entry_label').replace('{lang}', f.lang || '?').replace('{time}', f.ts)}" onkeydown="if(event.key==='Enter'||event.key===' ') { event.preventDefault(); loadFav('${f.id}'); }">
...
document.getElementById('clearFavsBtn').addEventListener('click', () => {
  ...
  renderFavorites();
  toast(getTranslation('toast_favorites_cleared'), 'info');
});
      function loadFav(id) {
        const normalizedId = normalizeSavedEntryId(id);
        if (normalizedId === null) return;
        const entry = favorites.find(f => f.id === normalizedId);
        restoreSavedEntry(entry);
      }

      window.loadFav = loadFav;
      /* ═══════════════════════════════════════════════════════════════
         DOWNLOAD
      ═══════════════════════════════════════════════════════════════ */
      ...
      function buildReport(r, code) {
        if (r.files) {
          const lines = ['QyverixAI Project ZIP Analysis', '', `Date: ${new Date().toLocaleString()}`, `Engine: ${r.provider || 'rule-based'}`, `Files: ${r.file_count}`, `Overall Score: ${r.overall_project_score}/100 (${r.grade})`, r.summary, ''];
          r.files.forEach(file => {
            lines.push(`FILE: ${file.filename}`, `Language: ${file.language}`, `Score: ${file.analysis.suggestions.overall_score}/100 (${file.analysis.suggestions.grade})`, file.analysis.debugging.summary, `Summary: ${file.analysis.explanation.summary}`, '');
            file.analysis.debugging.issues.forEach(i => lines.push(`[${i.severity.toUpperCase()}] ${i.type} (line ${i.line})`, `  ${i.description}`, `  Fix: ${i.suggestion}`, ''));
          });
          if (r.skipped_files?.length) lines.push('SKIPPED FILES', ...r.skipped_files, '');
          return lines.join('\n');
        }
        const lines = ['═══ QyverixAI Analysis Report ═══', '', `Date: ${new Date().toLocaleString()}`, `Engine: ${r.provider || 'rule-based'}`, ''];
        if (r.explanation) {
          lines.push('── EXPLANATION ──', `Language: ${r.explanation.language}`, `Complexity: ${r.explanation.complexity}`, `Summary: ${r.explanation.summary}`, '', ...r.explanation.key_points.map(p => `• ${p}`), '');
        }
        if (r.debugging) {
          lines.push('── DEBUGGING ──', r.debugging.summary, '');
          r.debugging.issues.forEach(i => lines.push(`[${i.severity.toUpperCase()}] ${i.type} (line ${i.line})`, `  ${i.description}`, `  Fix: ${i.suggestion}`, ''));
        }
        if (r.suggestions) {
          lines.push('── SUGGESTIONS ──', `Score: ${r.suggestions.overall_score}/100 (${r.suggestions.grade})`, r.suggestions.next_step, '');
          r.suggestions.suggestions.forEach(s => lines.push(`[${s.priority.toUpperCase()}] ${s.category}: ${s.description}`, ''));
        }
...
def calculate(a, b):
    # [!] No type hints, potential ZeroDivisionError
    result = a / b
    return result
...
function loadUser(id) {
  ...
  if (counter == "0") {  // [!] Loose equality
    console.log("No users loaded");
    document.getElementById("output").innerHTML = id;  // [!] XSS risk
  }
...
int main() {
    ...
    return 0;
      ...
      if (langSelect) {
        ...
        // Also listen for input for immediate responsiveness in some browsers
      ...
      if (apiUrlInput) {
        apiUrlInput.addEventListener('change', () => {
          localStorage.setItem('qyx_apiUrl', apiUrlInput.value);
        });
