        ...
        <div class="result-text">
          ${issues.length === 0
            ...
            : issues.map(i => `<div style="margin-bottom:10px">
                ...
                ${i.suggestion ? `<p style="color:var(--accent-green);margin-top:4px">Fix: ${i.suggestion}${i.ai_generated ? ' <span class="ai-badge" title="This fix was generated by AI — review before applying">✦ AI</span>' : ''}</p>` : ''}
              </div>`).join('')}
        </div>
      </div>`;
      ...
      <div class="result-text">
        ${issues.length === 0
          ...
          : issues.map(i => `<div style="margin-bottom:14px;padding:12px;background:var(--bg-2);border-radius:6px;border:1px solid var(--border)">
              ...
              ${i.suggestion ? `<p style="margin-top:6px;color:var(--accent-green)">→ ${i.suggestion}${i.ai_generated ? ' <span class="ai-badge" title="This fix was generated by AI — review before applying">✦ AI</span>' : ''}</p>` : ''}
            </div>`).join('')}
      </div>
    </div>`;
